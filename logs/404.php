...
<head>
    ...
    <style>
            ...
            .fourtime{
                animation: fourtime   2s  alternate  infinite;
                transform-origin: center;
            }
